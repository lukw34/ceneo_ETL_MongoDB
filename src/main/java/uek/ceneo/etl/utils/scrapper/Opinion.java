...
public class Opinion{
	...
	public Opinion(String disadvantages,String advantages,String productReview, 
		...
		//this.reviewTime.setTime(new java.util.Date(reviewTime));
		//System.out.println(this.reviewTime.getTime());
